#include "RLConnect4Scene.h"
#include "Game/Systems.h"

RLConnect4Scene::RLConnect4Scene(unsigned int width, unsigned int height) : Scene("Connect4"),
...
RLConnect4Scene::~RLConnect4Scene()
{
    m_Agent.savePolicyToFile("res/AI/Connect4Policy.rl");
}

void RLConnect4Scene::addAction(float xposition, size_t column)
{
...
void RLConnect4Scene::updateAgent(float gameOverReward, float defaultReward)
{
...
void RLConnect4Scene::onUpdate(Elysium::Timestep ts)
{
...
void RLConnect4Scene::onEvent(Elysium::Event& event)
{
    Elysium::EventDispatcher dispatcher(event);
    dispatcher.Dispatch<Elysium::MouseButtonPressedEvent>(BIND_EVENT_FUNCTION(RLConnect4Scene::onMousePressedEvent));
    dispatcher.Dispatch<Elysium::WindowResizeEvent>(BIND_EVENT_FUNCTION(RLConnect4Scene::onWindowResizeEvent));
}

bool RLConnect4Scene::onMousePressedEvent(Elysium::MouseButtonPressedEvent& event)
{
...
bool RLConnect4Scene::onWindowResizeEvent(Elysium::WindowResizeEvent& event)
{
