...
SandboxLayer::SandboxLayer(unsigned int width, unsigned int height) : Layer("Sandbox"), 
    m_Camera(-(float)width / 320, (float)width / 320, -(float)height / 320, (float)height / 320),
